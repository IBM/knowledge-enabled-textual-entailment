# modify from: https://github.com/allenai/allennlp/blob/v0.5.1/allennlp/models/decomposable_attention.py
...
class DecomposableAttention(Model):
    ...
    def forward(self,  # type: ignore
        ...
        if self._premise_encoder:
            embedded_premise = self._premise_encoder(
